...
public class Schnitt implements Shape {
    ...
    public Schnitt(Shape q1, Shape q2) {
        a = q1;
        b = q2;
        material = q1.getMaterial();
    }

    // TODO: intersection.x1 und x2 sowie intersections private machen und bessere Lösung finden
    ...
    public Intersection intersect(Vector3 origin, Vector3 direction) {
        ...
        if(i1.intersections == 2 && i2.intersections == 2) {
            ...
            if(intersections[0] == i1.x1 && intersections[1] == i2.x1) {
                return i2;
            }
            else if(intersections[0] == i2.x1 && intersections[1] == i1.x1) {
                return i1;
            }
        }
